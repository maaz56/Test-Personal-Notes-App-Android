...
public class TrashContract {
        ...
        public static class Trash implements TrashColumns, BaseColumns {
            public static final String CONTANT_TYPE = "vnd.android.cursor.dir/vnd." + CONTENT_AUTHORITY + "trash";
            public static final String CONTANT_ITEM_TYPE = "vnd.android.cursor.item/vnd." + CONTENT_AUTHORITY + "trash";
