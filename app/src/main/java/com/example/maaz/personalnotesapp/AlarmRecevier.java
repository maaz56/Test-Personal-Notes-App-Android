...
public class AlarmRecevier extends BroadcastReceiver {
    ...
    private void generateNotification(Context context, String reminder){
        ...
        Intent notificationItent = new Intent(context, NoteDetailActivity.class);
        notificationItent.putExtra(AppConstant.REMINDER, reminder);
        notificationItent.setFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
        TaskStackBuilder stackBuilder = TaskStackBuilder.create(context);
        stackBuilder.addNextIntent(notificationItent);
