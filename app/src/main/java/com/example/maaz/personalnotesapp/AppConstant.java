...
public class AppConstant {
    ...
    public static final String NO_ARCHIVE = "No ARCHIVES";
    ...
    public static final String NOTE_OR_REMINDER = "note or reminder";
    ...
    public static final String FOLDER_CREATE_ERROR = "Error while creating folder";
    ...
    public static final String MAKE_NOTES= "MAKE NOTES";
    ...
    public static final String DRAWER_HELP_FEEDBACK= "Help & Feedback";

    public static final String GOOGLE_DRIVE_ID = "Google drive id";
    ...
    public static final String GOOGLE_DRIVE_UPLOADER_BOOL= "google_drive_upload_dir";

    public static final String APP_KEY= "orur931lo59qpuo";
    public static final String APP_SECRET= "bx6ddyny7fi8hhb";
