...
public class AppProvider extends ContentProvider {
    ...
    public String getType(Uri uri) {
        ...
        switch (match) {
            ...
            case ARCHIVES_ID:
                return ArchivesContract.Archives.CONTANT_ITEM_TYPE;
            case TRASH:
                return TrashContract.Trash.CONTANT_TYPE;
            case TRASH_ID:
                return TrashContract.Trash.CONTANT_ITEM_TYPE;
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            ...
            case ARCHIVES_ID:
                ...
                String archivesSelectionCriteria = BaseColumns._ID + "=" + archiveId
                        + (!TextUtils.isEmpty(selection) ? " AND ( " + selection + ")" : "");
                return db.delete(AppDatabase.Tables.ARCHIVES, archivesSelectionCriteria, selectionArgs);
